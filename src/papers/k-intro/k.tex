...
\Klang{} for all numerical collections. The \code{size} function is the same as
...
\code{req} (require) keyword. The constraint specifies that the size function of
...
Line 39 invokes the \code{FileSystem} constructor as well
