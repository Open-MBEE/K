...
\lstdefinelanguage{K}{
  morekeywords={package,import,class,extends,with,match,new,if,then,else,while,for,yield,val,var,this,case,type,implicit,private,protected,abstract,final, req, Int, String, Bool, fun, pre, post},
  otherkeywords={&,\{,\},_*},
  literate=
      {\#\#}{{$\oplus\;$}}2
      {|->}{{$\longmapsto\;$}}2
...
\lstdefinelanguage{SMT}{
  morekeywords={define,declare,sort,const,fun,datatypes,assert,forall,exists,and,or,ite,Int,Real,Bool},
  sensitive=true, 
  morecomment=[l]{;}, 
  stringstyle=\ttfamily,
  numbers=left,   
