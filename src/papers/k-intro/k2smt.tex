...
class, such as class \code{Object}.  We have chosen to translate
...
can be retrieved using selector functions.  The class \code{Object}
...
We can now in SMT-LIB use \code{Ref} as the type of properties who's 
