...
\code{Real}), user-defined class types, and tuple types (cartesian
...
The example illustrates the features of K
...
class \code{Thing}. The class \code{Instr} defines a \code{power}
...
case is either \code{SmplRadio} or \code{SmartRadio}. This is
...
\centering
  ...
  \small
  \begin{tabular}{c}
    \lstinputlisting{examples/spacecraftOutput.k}% 
